...
ceneHouseTableWorld_test_predicats = SceneSpec(
    'housetableworld',
    objects=(
        # Define objects in the HouseTableWorld scene
        ObjectSpec('bin_dark_wood', base_pos=[0.0, -0.6, 0.]),  # Bin object
...
muj_env_config = dict(
    # scene=sceneHouseTableWorld_forhas_space_down,  # Use the HouseTableWorld scene
    scene=ceneHouseTableWorld_test_predicats,
    robots=dict(
