...
print("\n[TEST] has_space_cup_rack() and has_space_utensil_rack()\n")

# === Test 1: Fill cups until full ===
print("\n-- Test 1: Filling cup rack to capacity --")
...
for name in cup_names:
    has_space_cup = evaluator.has_space_cup_rack()
    print(f"has_space_cup_rack() = {has_space_cup}")
    assert has_space_cup, "❌ Expected empty space in cup rack, but got False"
    print("✅ Cup rack correctly detected as not full")
...
has_space_cup = evaluator.has_space_cup_rack()
print(f"has_space_cup_rack() = {has_space_cup}")
assert not has_space_cup, "❌ Expected no space in cup rack, but got True"
print("✅ Cup rack correctly detected as full")
print("\n" * 5)
executor.wait(100)
...
assert has_space_utensil, "❌ Expected to find space in utensil rack, but got False"
print("✅ Utensil rack correctly detected as not full")
...
# # print("will move the arrow")
# # env._mj_data.body('arrow/arrow').xpos[:] = [0, 0, 1.0]
# # env.simulate_steps(5)
# # executor.wait(30)
# # print("Arrow moved to:", env._mj_data.body('arrow/arrow').xpos)
# # print("Arrow moved to:", env._mj_data.body('arrow/').xpos)
# # print("arrow moved and wiated \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n")
# # env._mj_data.body('arrow/arrow').xpos[:] = [1, 2, 1.0]
# # env.simulate_steps(5)
# # executor.wait(30)
# # print("Arrow moved to:", env._mj_data.body('arrow/arrow').xpos)
...
# env.open_top_rack()
# print("Top rack opened")
# executor.wait(10)
# print("after wait")
# env.close_top_rack()
# print("Top rack closed")

# # env.place_object_in_dishwasher('wooden_fork/dish11_fj/', [0.77, -0.18, 0.37]) 
# # knife d5lt  block in the right
# # env.point_arrow_to_object('knife/dish13_fj/')
# # print("pointing to knife \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n")
# # executor.wait(30)
# # env.point_arrow_to_object('tall_cup_8/dish27_fj/')
# # print("pointing to tall cup \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n \n")
# # env.select_body('tall_cup_8/dish27_fj/')
# executor.wait(30)
# # env.select_body('spoon/object')
