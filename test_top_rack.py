...
time.sleep(1)  # Additional wait to ensure everything is loaded properly
...
time.sleep(10)  # Wait for the door to open
...
geom1_name='plate_1//unnamed_geom_0'
print(env.get_valid_geometry_names())
...
for geom_name in geom_names :
    if 'plate' in geom_name.lower():
        ...
        if normal_force[2] not in [0, 0.0]:
            num_plats += 1
print(f"Number of plates in the dishwasher: {num_plats}")
